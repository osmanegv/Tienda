...
<body>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item active" href="computo.php">
                                        <h5>Computo</h5>
                                    </a>
    ...
    $resultado=$conex -> query("select * from producto where categoria_producto=2") or die($conex ->error);
    ...
    <div class="col-xs-12 col-md-6 col-lg-4 " >
      <div class="block-4 text-center border shadow p-3 mb-5 bg-white rounded"style="height: 22.5rem;">
        <figure class="block-4-image">
          <a href="producto.php? id=<?php echo $fila['id_producto'];?>"><img src="img_productos/<?php echo $fila['imagen_producto'];  ?>" alt="image placheholder" width="160px" class="img-fluid mt-1"></a>
        </figure>
