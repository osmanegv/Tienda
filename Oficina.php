...
<html lang="es">
  <head>
    ...
    />
    <script
      src="https://kit.fontawesome.com/2803c554a7.js"
  ...
  <body>
              ...
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="Impresoras.php"
                      >Impresoras
                    </a>
                    <a class="dropdown-item" href="Accesorios.php"
                      >Accesorios
                    </a>
                    <a class="dropdown-item active" href="Oficina.php"
                      ><h5>Oficina</h5></a
                    >
                  </div>
                </li>
    ...
    $resultado=$conex -> query("select * from producto where categoria_producto=5") or die($conex ->error);
    ...
    <div class="col-xs-12 col-md-6 col-lg-4 " >
      <div class="block-4 text-center border shadow p-3 mb-5 bg-white rounded"style="height: 22.5rem;">
        <figure class="block-4-image">
          <a href="producto.php? id=<?php echo $fila['id_producto'];?>"><img src="img_productos/<?php echo $fila['imagen_producto'];  ?>" alt="image placheholder" width="170px" class="img-fluid mt-1"></a>
        </figure>
        <div class="block-4-text p-4 heigth-15">
            <h6><a href="producto.php? id=<?php echo $fila['id_producto'];?>"><?php echo $fila['nombre_producto'];  ?></a></h6>
            <p class="mb-0"><?php echo $fila['desc_producto'];  ?></p>
            <p class="text-primary font-weigth-bold">Q<?php echo $fila['precio_producto'];  ?></p>
